...
Benchmarking etcd performance can be done with the [benchmark](https://github.com/skilld-labs/etcd/tree/master/tools/benchmark) CLI tool included with etcd.
