...
import (
	...
	"github.com/skilld-labs/etcd/pkg/cors"
	"github.com/skilld-labs/etcd/pkg/debugutil"
	runtimeutil "github.com/skilld-labs/etcd/pkg/runtime"
...
var plog = capnslog.NewPackageLogger("github.com/skilld-labs/etcd", "embed")
...
func stopServers(ctx context.Context, ss *servers) {
	...
	// and https://github.com/skilld-labs/etcd/issues/8916
	if ss.secure {
		shutdownNow()
		return
	}
