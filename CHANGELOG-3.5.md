...
- `github.com/skilld-labs/etcd` Go packages have moved to `github.com/skilld-labs/etcd/v3` to follow the [Go modules](https://github.com/golang/go/wiki/Modules) conventions
