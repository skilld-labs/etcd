...
[![GoDoc](https://godoc.org/github.com/skilld-labs/etcd/client?status.png)](https://godoc.org/github.com/skilld-labs/etcd/client)
...
```bash
go get github.com/skilld-labs/etcd/v3/client
```
